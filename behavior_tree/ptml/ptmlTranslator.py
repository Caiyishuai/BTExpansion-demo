...
from behavior_lib._base import Selector, Sequence, Inverter
from behavior_lib.any_tree_node import AnyTreeNode
from antlr4 import *
...
class ptmlTranslator(ptmlListener):
    ...
    def __init__(self, scene, behaviour_lib_path=None) -> None:
        super().__init__()
        self.bt_root = None
        self.stack = []
        self.scene = scene
    ...
    def enterAction_sign(self, ctx: ptmlParser.Action_signContext):
        ...
        node = AnyTreeNode(node_type, name, args)
